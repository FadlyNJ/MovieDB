...
public class DataAdapterFavourite extends RecyclerView.Adapter<com.fadly.moviedb.DataAdapterFavourite.DatakuViewHolder> {
    private List<com.fadly.moviedb.ModelMovieRealm> dataList;
    ...
    public DataAdapterFavourite(List<com.fadly.moviedb.ModelMovieRealm> dataList, Callback callback) {
