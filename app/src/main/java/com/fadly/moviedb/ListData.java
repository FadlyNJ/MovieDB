...
public class ListData extends AppCompatActivity {
    ...
    com.fadly.moviedb.DataAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog = new ProgressDialog(com.fadly.moviedb.ListData.this);
    ...
    void addData() {
        ...
        adapter = new com.fadly.moviedb.DataAdapter(DataArrayList, new com.fadly.moviedb.DataAdapter.Callback() {
            @Override
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(com.fadly.moviedb.ListData.this);
                        ...
                        try {
                            ...
                            adapter = new com.fadly.moviedb.DataAdapter(DataArrayList, new com.fadly.moviedb.DataAdapter.Callback() {
                                ...
                                public void onClick(int position) {
                                    ...
                                    Intent intent = new Intent(getApplicationContext(), com.fadly.moviedb.DetailMovie.class);
                                    ...
                                    Toast.makeText(com.fadly.moviedb.ListData.this, ""+position, Toast.LENGTH_SHORT).show();
                                }
